...
public class ConexaoBD {
    ...
    public ConexaoBD() {
        try {
            ...
            Prompts.promptErro("Erro ao conectar com o banco de dados. Verifique o log.");
    ...
    public void shutDown() {
        try {
            ...
            Prompts.promptErro("Erro ao fechar a conexão com o banco de dados. Verifique o log.");
            System.out.println("Erro: " + e.getMessage());
        }
    }
}
