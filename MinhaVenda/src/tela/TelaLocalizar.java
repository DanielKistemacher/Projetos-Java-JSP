 ...
 * @author pretto
 */
public class TelaLocalizar extends javax.swing.JDialog {
     ...
     */
    public TelaLocalizar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    // construtor secundario
    public TelaLocalizar(java.awt.Frame parent, boolean modal, IItemPesquisa origem, String itemPesquisa) {
        super(parent, modal);
        initComponents();
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        if (itemPesquisa.equalsIgnoreCase("pessoa")) {
            new ClienteDAO().preencherTabela(tblItemPesquisa, tfdDescricaoPesquisa.getText());
        } else if (itemPesquisa.equalsIgnoreCase("item")) {
            new ProdutoDAO().preencherTabela(tblItemPesquisa, tfdDescricaoPesquisa.getText());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLocalizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaLocalizar dialog = new TelaLocalizar(new javax.swing.JFrame(), true);
